...
# This script computes the "essential" trap spaces of a single, 
...
traps = TrapSpaces.essential_symbolic(ctx, stg)

if limit is None:
	print(f"Complete interpretations: {traps.cardinality()}")
else:
	count = 0
